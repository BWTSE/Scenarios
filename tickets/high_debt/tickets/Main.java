...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<TicketTypeInterface> applicableTickets = ticketFinder.find(
            carl, 
            new Trip(Zone.CENTRAL, Zone.CENTRAL, time), 
            2000);
        Optional<Ticket> ticketOpt;

        for (TicketTypeInterface ticketType : applicableTickets) {
    ...
    private static List<TicketTypeInterface> buildTicketTypeList() {

        List<TicketTypeInterface> ticketTypeList = new LinkedList<>();
