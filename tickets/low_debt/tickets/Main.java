...
public class Main {
    ...
    private static final List<AbstractTicketType> ticketTypeList = new LinkedList<>();
    ...
    public static void main(String[] args) {
        ...
        List<AbstractTicketType> aliceTickets = 
        ...
        List<AbstractTicketType> bobTickets = 
        ...
        List<AbstractTicketType> carlTickets = 
